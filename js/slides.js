...
const defaultText = document.getElementById('mosDefaultText');

const cloud = document.querySelector('#cloud');
const cloudButton = document.getElementById('mosCloudButton');

function showCloudButton() {
    defaultText.style.display = 'none';
    cloudButton.style.display = 'block';
}

function hideCloudButton() {
    defaultText.style.display = 'block';
    cloudButton.style.display = 'none';
}

cloud.addEventListener('mouseover', showCloudButton);
cloud.addEventListener('mouseout', hideCloudButton);

const iot = document.querySelector('#iot');
const iotButton = document.getElementById('mosIOTButton');

function showIOTButton() {
    defaultText.style.display = 'none';
    iotButton.style.display = 'block';
}

function hideIOTButton() {
    defaultText.style.display = 'block';
    iotButton.style.display = 'none';
}

iot.addEventListener('mouseover', showIOTButton);
iot.addEventListener('mouseout', hideIOTButton);

const manufacturing = document.querySelector('#manufacturing');
const manufacturingButton = document.getElementById('mosManuButton');

function showManuButton() {
    defaultText.style.display = 'none';
    manufacturingButton.style.display = 'block';
}

function hideManuButton() {
    defaultText.style.display = 'block';
    manufacturingButton.style.display = 'none';
}

manufacturing.addEventListener('mouseover', showManuButton);
manufacturing.addEventListener('mouseout', hideManuButton);

const product = document.querySelector('#product');
const productButton = document.getElementById('mosProductButton');
...
product.addEventListener('mouseover', showProductButton);
product.addEventListener('mouseout', hideProductButton);

const fab = document.querySelector('#fab');
const fabButton = document.getElementById('mosFabButton');
...
fab.addEventListener('mouseover', showFabButton);
fab.addEventListener('mouseout', hideFabButton);

const automation = document.querySelector('#automation');
const automationButton = document.getElementById('mosMachineButton');

function showAutomationButton() {
    defaultText.style.display = 'none';
    automationButton.style.display = 'block';
}

function hideAutomationButton() {
    defaultText.style.display = 'block';
    automationButton.style.display = 'none';
}

automation.addEventListener('mouseover', showAutomationButton);
automation.addEventListener('mouseout', hideAutomationButton);

const ai = document.querySelector('#ai');
const aiButton = document.getElementById('mosAIButton');
...
ai.addEventListener('mouseover', showAIButton);
ai.addEventListener('mouseout', hideAIButton);
}